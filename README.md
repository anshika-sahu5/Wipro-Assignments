# Database Management Systems (DBMS) Assignments

This repository contains a structured collection of my database assignments, organized topic-wise into separate folders. Each topic includes detailed documentations, problem statements, and solutions.
...
*   **`Topic-01-ER-Modeling/`**: Conceptual database design, Entity-Relationship diagrams, and schema design.
*   **`Topic-02-Relational-Calculus/`**: Theoretical database queries, relational algebra, and tuple relational calculus.
*   **`Topic-03-SQL-Queries/`**: Practical implementations of DDL, DML, complex Joins, Subqueries, and Aggregate functions.
